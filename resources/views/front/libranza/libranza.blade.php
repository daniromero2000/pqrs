        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <hr>
                    <p class="libranzaText text-justify">
                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Monto del crédito:</strong> El
                        monto
                        máximo del crédito
                        corresponderá a la suma aprobada SOCOMIR de conformidad con sus políticas de crédito
                        vigentes.<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Intereses Moratorios:</strong>
                        Será la
                        máxima permitida por la ley para el momento de su
                        cobro.<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Monto Desembolsado:</strong>
                        ...
                        Impuestos y comisiones bancarias derivadas del otorgamiento del crédito. <br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Plazo:</strong> El plazo mínimo
                        será el
                        ...
                        y/o
                        b) La capacidad de descuento del cliente o el valor de la cuota se reduzca.<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Cuota:</strong> La cuota del
                        crédito de
                        ...
                        la
                        capacidad de descuento del cliente se reduzca.<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Cargos incluidos dentro del valor
                            mensual de la cuota:</strong> Capital (incluye conceptos
                        capitalizados), intereses, seguros y aportes (si aplica).<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Tasa de interés
                            remuneratoria:</strong>
                        ...
                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Pago intereses iniciales:</strong>
                        ...
                        desembolso o capitalizarse en la obligación.<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Distribución del pago de la cuota
                            mensual o pago mínimo:</strong> El pago de la cuota
                        ...
                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Comisiones y recargos que se
                            aplicarán:</strong> Las comisiones y recargos aplicables a la
                        ...
                        gestión de cobranza (si aplica).<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Seguro de vida grupo
                            deudores:</strong>
                        ...
                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Tipo de cobertura de garantía -
                            Aval:</strong> La aprobación del crédito podrá estar sujeta
                        ...
                        acuerdo
                        con el perfil de riesgo del solicitante.<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Pagaré:</strong> La obligación se
                        ...
                        calculados
                        a la tasa pactada entre las partes <br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Gastos de cobranza:</strong>
                        Estarán a
                        ...
                        tarifas
                        se informarán en http://www.socomir.org<br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Derecho de prepago:</strong> el
                        cliente
                        podrá en cualquier momento realizar el pago parcial
                        o total del saldo de su obligación sin incurrir en ningún tipo de sanción o penalidad. <br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Cláusula Aceleratoria:</strong> En
                        el
                        ...
                        legalmente
                        a partir del incumplimiento. <br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Condiciones excepcionales de
                            reestructuración:</strong> De conformidad con el manual de
                        crédito. <br><br>

                        <i class="fa fa-check yellow" aria-hidden="true"></i> <strong>Cláusula de Retractación:</strong>
                        Se
                        ...
                        puntos
                        de atención de la Cooperativa y por escrito su solicitud de retractación.<br><br>
