                ...
                <div class="col-md-10">
                    <ul class="list-unstyled">
                        <li> <a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/RADICADO FORMULARIO 5245.pdf')}}"><i
                        ...
                        <li><a target="_blank" class="reglamentos" href="{{asset('/pdf/RADICA FORMATO 2530.pdf')}}"><i
                                    class="fa fa-angle-right yellow" aria-hidden="true"></i> Radicado Formato 2530</a>
                        </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Informe de Gestión 2018.pdf')}}"><i class="fa fa-angle-right yellow"
                                    aria-hidden="true"></i> Informe de Gestión 2018</a> </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Estados Finanieros 2018.pdf')}}"><i class="fa fa-angle-right yellow"
                                    aria-hidden="true"></i> Estados Financieros 2018</a> </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Certificación Antecedentes.pdf')}}"><i
                                    class="fa fa-angle-right yellow" aria-hidden="true"></i> Certificación
                                Antecedentes</a> </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Certificacion Revisar Fiscal.pdf')}}"><i
                                    class="fa fa-angle-right yellow" aria-hidden="true"></i> Certificación Revisar
                                Fiscal</a> </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Certificacion ingresos.pdf')}}"><i class="fa fa-angle-right yellow"
                                    aria-hidden="true"></i> Certificación ingresos</a> </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Camara de Comercio Socomir.pdf')}}"><i
                                    class="fa fa-angle-right yellow" aria-hidden="true"></i> Camara de Comercio
                                Socomir</a> </li>
                        <li><a target="_blank" class="reglamentos"
                                href="{{asset('/pdf/Acta No 01 constitución SOCOMIR.pdf')}}"><i
